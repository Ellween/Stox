            ...
            <li class="nav-item">
             ...
             <li class="nav-item">
                ...
                <div class="login d-flex align-items-center">
                    ...
                    @else
                    <a class="nav-link" href="#" data-toggle="modal" data-target="#Login-Signup">LOGIN / REGISTER</a>
                    @endif
                </div>
            </li> 
        </ul>
...
<div class="modal fade "  id="Login-Signup" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" aria-modal="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <hr>
        @if($errors->any())
        <h4 style="text-align:center; color:red; padding-top: 10px;s">{{$errors->first()}}</h4>
        @endif
        ...
        <div class="modal-body login-form active">
          ...
          <form class='login-in-form form-horizontal' method="POST" action="{{ route('login_dashboard_user') }}">
                {{ csrf_field() }}
            <div class="e-mail">
        ...
        <div class="modal-body  sing-up-block">
            <form class='sign-up-form' id='myform' style ='padding: 0px 0px 50px 0px !important;' method="POST" action="{{ route('login_user') }}">
                {{ csrf_field() }}
                ...
                <div class="email">
                    <input type="email" id ='sign_email' class='form-control' id='email' placeholder="E-mail" name ='email'>
                </div>
                <div class="phone">
                ...
                <div class="password">
                    <input id='pass' type="password" class='form-control' placeholder="Password" name ='sign_password'>
                </div>
                <div class="conf-password">
                    <input type="password" class='form-control' placeholder="Confirm Password" name ='password_confirm'>
                </div>
                <div class="submit-btn">
                    <button type="submit submit-sign-up">Open Account For Free</button>
                </div>
            </form>
        </div>
