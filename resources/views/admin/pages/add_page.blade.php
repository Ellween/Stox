                    ...
                    <form action="/add_page" method="POST">
                      @csrf
                        ...
                        <div class="page_url">
                            ...
                            <input type="text" name='url' class='form-control' placeholder="Page Url">
                        </div>
                        <div class="page_content">
                            <label for="">Page Content</label>
                            <textarea name="content"  class='my-editor' id="content" cols="30" rows="10" class='form-control'></textarea>
                        </div>
